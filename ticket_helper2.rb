...
class Reocurring_text_generation
  ...
  def task_esculation(c_email,c_name,c_unit,sr,t_title,c_tel,desc)
    ...
    printf "Summary        %-1s is requesting assitance with %s\n", c_unit, t_title
  ...
  def generic_opening_response(sr,title)
   ...
   puts "ticket action"
   puts "==============================="
   puts "notfied customer of ticket activation"
  end
  ...
  def sig_field()
    ...
    puts "email: ted_knab@aotx.uscourts.gov"
...
def menu_list()
  ...
  puts "...use example: " + $0 + " -mi 4 -ce ted_knab@mdb.uscourts.gov -sr 32316 -ti 'firewall issue' -ta 82488 -te steve_park@aotx.uscourts.gov"
  puts "----------------------------------"
  ...
  puts "...use example: " + $0 + " -mi 6 -ce ted_knab@mdb.uscourts.gov -sr 32316 -ti 'firewall issue' -ta 82488 -te steve_park@aotx.uscourts.gov"
  puts "----------------------------------"
